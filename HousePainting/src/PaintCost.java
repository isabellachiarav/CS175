...
public class PaintCost {
	...
	public static void main(String[] args) {
		...
		windowLengthInches += windowLengthInches/12;
		...
		sqFtPeak = (houseLengthFeet * houseWidthFeet) + ((1/2) * (houseLengthFeet * (houseHeightFeet - houseWidthFeet)));
		...
		sqFtWindows = windowLengthFeet * windowWidthFeet;
		sqFtWindows = sqFtWindows * windowNumber;
		
		//Calculate the square footage of the doors
		sqFtDoors = doorLengthFeet * doorWidthFeet;
		sqFtDoors = sqFtDoors * doorNumber;
		
		//Find the total square footage of the house
		sqFtTotal = (2 * sqFtPeak) + (2 * sqFtNormal);
		sqFtTotal = sqFtTotal - sqFtWindows - sqFtDoors;
		
		//Find the total cost of painting the house
		sqFtCost = sqFtCost * sqFtTotal;
		...
		/*
		 * 
Multiply the square footage by the cost per 
